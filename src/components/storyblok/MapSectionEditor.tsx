  ...
  const renderIcon = () => {
    switch (blok.icon_type) {
      ...
      case 'parking':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="hotfix-icon">
            <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125v-3.5m-9.75 0h6.75m-6.75 0V9.375a1.125 1.125 0 0 1 1.125-1.125h3.75A1.125 1.125 0 0 1 18 9.375v3.375m-9.75 0h3.75m-3.75 0v-3.375M6 12V7.5m0 0v-3M6 7.5h6.75m-6.75 0h-3" />
          </svg>
        );
      case 'calendar':
        return (
