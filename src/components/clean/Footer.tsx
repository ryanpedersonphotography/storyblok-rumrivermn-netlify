    ...
    <footer className="footer" data-section="footer">
        ...
        <div className="footer__content">
          ...
          <div className="footer__section">
            <h3 className="footer__title">Rum River Barn</h3>
            <p className="footer__description">
              Creating unforgettable wedding experiences in the heart of Minnesota since 2010.
            </p>
          </div>

          {/* Contact Section */}
          <div className="footer__section">
            <h3 className="footer__section-title">Find Us</h3>
            <div className="footer__contact">
              <div className="footer__address">
                <MapPinIcon className="w-5 h-5 flex-shrink-0" />
                <span>
                  12345 Rum River Road<br />
                  Princeton, MN 55371
                </span>
              </div>
              <a href="tel:7635550123" className="footer__phone-link">
                <PhoneIcon className="w-5 h-5" />
                <span>(763) 555-0123</span>
              </a>
            </div>
          </div>
        ...
        <div className="footer__bottom">
          <p className="footer__copyright">&copy; {new Date().getFullYear()} Rum River Barn. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
